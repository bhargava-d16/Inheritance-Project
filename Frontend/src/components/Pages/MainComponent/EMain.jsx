  ...
  const OnSearch = async () => {
    try {
      const searchres = await axios.get(
        "https://inheritance-project-4kr9.onrender.com/EDashboard/search",
        {
          params: { search },
        }
      );
  ...
  return (
    <div className="Emain">
      <div className="heading bg-red-500">
        ...
        <p>
          Discover a pool of talented, multi-skilled candidates ready to elevate
          your business. Our platform simplifies the hiring process, ensuring
          you find the right fit quickly and efficiently.
        </p>
      </div>
      <div className="X">
        <div>
        ...
        <div className="candidatesFilterbuttons">
          ...
          <button
            className="filterbtns"
            onClick={() => handleFilterChange("notworking")}
          >
