        ...
        <div className="relative w-48 h-48 mb-6">
          <div className="w-full h-full rounded-full overflow-hidden border-4 border-[#CBDCEB] shadow-lg">
            {loading ? (
              <div className="w-full h-full flex items-center justify-center bg-gray-50">
                <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#133E87] border-t-transparent"></div>
              </div>
            ) : error ? (
              <div className="w-full h-full flex items-center justify-center bg-gray-50">
          ...
          {!editing && (
            <button
              ...
              className="absolute bottom-2 right-2 p-3 bg-[#133E87] text-white rounded-full shadow-lg"
            >
        ...
        {editing && (
          <div className="w-full space-y-4">
            <label className="block">
              <div className="bg-[#133E87] text-white py-3 px-4 rounded-lg cursor-pointer hover:bg-[#608BC1] transition-colors duration-200 text-center font-medium">
                Choose New Photo
                <input
                  type="file"
                  name="profilepic"
